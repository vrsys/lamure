  ...
  has_layout_(create_layout) {
    ...
    if (has_layout_) {
        ...
        pcl_qz_memory_ = device->create_vertex_array(scm::gl::vertex_format
            (0, 0, scm::gl::TYPE_USHORT, size_of_surfel_qz_)  // quant. pos x 16b
            (0, 1, scm::gl::TYPE_USHORT, size_of_surfel_qz_)  // quant. pos y 16b
            (0, 2, scm::gl::TYPE_USHORT, size_of_surfel_qz_)  // quant. pos z 16b
