...
public:
    ...
    const uint32_t      get_size_of_provenance() const { return size_of_provenance_; }
    ...
    void                set_size_of_provenance(const uint32_t size_of_provenance) { size_of_provenance_ = size_of_provenance; }
