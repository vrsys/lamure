...
class triangle_t
{
  public:
    ...
    bool operator==(const triangle_t& r) const { return (v0_.pos_ == r.v0_.pos_ && v1_.pos_ == r.v1_.pos_ && v2_.pos_ == r.v2_.pos_); }

    const bool is_congruent_triangle(const vec3f& v0, const vec3f& v1, const vec3f& v2)
    {
        bool b[9];
        b[0] = v0_.pos_ == v0;
        b[1] = v0_.pos_ == v1;
