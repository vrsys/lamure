...
namespace seb{
    ...
    public:
        ...
        static uint16_t getInsatnceCount(){
        ...
        AbstractBufferSlot<TileRequest<priority_type>*> *getSlot(){
            return _slot;
        }

        void setSlot(AbstractBufferSlot<TileRequest<priority_type>*> *slot){
            _slot = slot;
        }
        ...
        chrono::high_resolution_clock::time_point getCreatedAt(){
            return _createdAt;
        }
