...
class PriorityQueueContent
{
  ...
  public:
    ...
    virtual ~PriorityQueueContent() { remove(); }
    ...
    virtual priority_type getPriority() { return _priority.load(); }

    virtual PriorityQueueEntry<priority_type> *getEntry() { return _entry.load(); }
};
...
template <typename priority_type>
PriorityQueueEntry<priority_type>::PriorityQueueEntry(PriorityQueueContent<priority_type> *content, PriorityQueue<priority_type> &queue)
...
class PriorityQueue : public AbstractQueue<PriorityQueueContent<priority_type> *>
{
  ...
  public:
    ...
    virtual bool pop(PriorityQueueContent<priority_type> *&content, const chrono::milliseconds maxTime)
    {
        ...
        this->_newEntry.wait_for(lock, maxTime, [this] { return this->_first.load() != nullptr; });
    ...
    virtual bool popLeast(PriorityQueueContent<priority_type> *&content, const chrono::milliseconds maxTime)
    {
        ...
        this->_newEntry.wait_for(lock, maxTime, [this] { return this->_last.load() != nullptr; });
