...
class Bitmap
{
  ...
  protected:
    ...
    static void
    _inflatePixel(const uint8_t* const srcPx, PIXEL_FORMAT srcFormat, uint8_t* const destPx0, uint8_t* const destPx1, uint8_t* const destPx2, uint8_t* const destPx3, PIXEL_FORMAT destFormat);
