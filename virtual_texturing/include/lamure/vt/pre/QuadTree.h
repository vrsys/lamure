...
class QuadTree
{
  public:
    ...
    static inline uint64_t firstIdOfLevel(size_t level) { return (uint64_t)0x5555555555555555 ^ ((uint64_t)0x5555555555555555 << (level << 1)); }

    static inline uint64_t getWidthOfLevel(size_t level) { return (uint64_t)0x1 << level; }
