...
{
    uint64_t num = ((uint64_t)data[0]) | (((uint64_t)data[1]) << 8) | (((uint64_t)data[2]) << 16) | (((uint64_t)data[3]) << 24) | (((uint64_t)data[4]) << 32) | (((uint64_t)data[5]) << 40) |
...
uint64_t AtlasFile::getFilledTiles() { return _filledTileCount; }

uint64_t AtlasFile::getTotalTiles() { return _totalTileCount; }

uint32_t AtlasFile::getDepth() { return _treeDepth; }

uint64_t AtlasFile::getImageWidth() { return _imageWidth; }

uint64_t AtlasFile::getImageHeight() { return _imageHeight; }

uint64_t AtlasFile::getTileWidth() { return _tileWidth; }

uint64_t AtlasFile::getTileHeight() { return _tileHeight; }

uint64_t AtlasFile::getInnerTileWidth() { return _innerTileWidth; }

uint64_t AtlasFile::getInnerTileHeight() { return _innerTileHeight; }

uint64_t AtlasFile::getTileByteSize() { return _tileByteSize; }

uint64_t AtlasFile::getPadding() { return _padding; }

Bitmap::PIXEL_FORMAT AtlasFile::getPixelFormat() { return _pxFormat; }

AtlasFile::LAYOUT AtlasFile::getFormat() { return _format; }
...
float AtlasFile::getCielabValue(uint64_t id) { return _cielabIndex->getCielabValue(id); }
...
uint64_t AtlasFile::getOffsetIndexOffset() { return this->_offsetIndexOffset; }

uint64_t AtlasFile::getCielabIndexOffset() { return this->_cielabIndexOffset; }

uint64_t AtlasFile::getPayloadOffset() { return _payloadOffset; }

uint64_t AtlasFile::getImageTiledWidth() { return _imageTileWidth; }

uint64_t AtlasFile::getImageTiledHeight() { return _imageTileHeight; }

const char* AtlasFile::getFileName() { return _fileName; }
} // namespace pre
} // namespace vt
