...
#include <lamure/xyz/normal_computation_plane_fitting.h>
#include <lamure/xyz/radius_computation_average_distance.h>
#include <lamure/xyz/radius_computation_natural_neighbours.h>
#include <lamure/xyz/reduction_normal_deviation_clustering.h>
#include <lamure/xyz/reduction_constant.h>
#include <lamure/xyz/reduction_every_second.h>
#include <lamure/xyz/reduction_random.h>
#include <lamure/xyz/reduction_entropy.h>
#include <lamure/xyz/reduction_particle_simulation.h>
#include <lamure/xyz/reduction_hierarchical_clustering.h>
#include <lamure/xyz/reduction_k_clustering.h>
#include <lamure/xyz/reduction_spatially_subdivided_random.h>
#include <lamure/xyz/reduction_pair_contraction.h>
#include <lamure/xyz/reduction_hierarchical_clustering_mk5.h>
...
boost::filesystem::path builder::downsweep(boost::filesystem::path input_file, uint16_t start_stage) const{
    ...
    do {
        ...
        lamure::xyz::bvh bvh(memory_limit_, desc_.buffer_size, desc_.rep_radius_algo);
