           ...
           const size_t start_node_id) const
{
    if (input[0]->has_provenance()) {
      throw std::runtime_error("reduction_hierarchical_clustering_mk4 not supported for PROVENANCE");
    }
    ...
    real maximum_variation_color = 0.75;
...
scm::math::mat3d reduction_hierarchical_clustering_mk4::
...
real reduction_hierarchical_clustering_mk4::
...
vec3r reduction_hierarchical_clustering_mk4::
