...
reduction_strategy *builder::get_reduction_strategy(reduction_algorithm algo) const
{
    switch (algo) {
        ...
        case reduction_algorithm::entropy:return new reduction_entropy();
        case reduction_algorithm::particle_sim:return new reduction_particle_simulation();
        case reduction_algorithm::hierarchical_clustering:return new reduction_hierarchical_clustering();
        case reduction_algorithm::k_clustering:return new reduction_k_clustering(desc_.number_of_neighbours);
        case reduction_algorithm::spatially_subdivided_random:return new reduction_spatially_subdivided_random();
        case reduction_algorithm::pair:return new reduction_pair_contraction(desc_.number_of_neighbours);
        case reduction_algorithm::hierarchical_clustering_extended:return new reduction_hierarchical_clustering_mk5();
        default:LOGGER_ERROR("Non-implemented reduction algorithm");
            return nullptr;
    };
}
