...
class ReductionConstant: public ReductionStrategy
{
public:

    explicit            ReductionConstant() { }
...
private:
    ...
    static std::pair<vec3ui, vec3b> compute_grid_dimensions(const std::vector<SurfelMemArray*>& input,
