...
#ifndef PRE_PRE_FORMAT_XYZ_CPN_H_
#define PRE_PRE_FORMAT_XYZ_CPN_H_
...
class PREPROCESSING_DLL format_xyz_cpn: public format_abstract
{
public:
    explicit format_xyz_cpn()
        : format_abstract()
    {
        has_normals_ = true;
        has_radii_ = false;
