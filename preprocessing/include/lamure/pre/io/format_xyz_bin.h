...
#ifndef PRE_FORMAT_XYZ_BIN_H_
#define PRE_FORMAT_XYZ_BIN_H_
...
class PREPROCESSING_DLL format_xyz_bin : public format_abstract
{
public:
    explicit            format_xyz_bin()
                            : format_abstract()
                            { has_normals_ = true;
                              has_radii_   = true;
                              has_color_   = true; }
