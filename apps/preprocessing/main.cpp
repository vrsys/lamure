...
int main(int argc, const char *argv[])
{
    ...
    if (vm.count("convert")) {
        ...
        if (normal_computation_algo == "planefitting")
            desc.normal_computation_algo      = lamure::pre::NormalComputationAlgorithm::PlaneFitting;
        else {
        ...
        if (radius_computation_algo == "averagedistance")
            desc.radius_computation_algo      = lamure::pre::RadiusComputationAlgorithm::AverageDistance;
        else {
