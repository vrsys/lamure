...
int main(int argc, char* argv[])
{
    ...
    uint32_t data_world_map_id = vt::CutDatabase::get_instance().register_dataset("/mnt/data_internal/geometry_data/arctron_point_scans/Igeler_Saeule/Bilder/Extrem3.atlas");
