...
float Image::get_width_world()
{
    return (1.0f/_fp_resolution_x) * _width;
}

float Image::get_height_world()
{
    return (1.0f/_fp_resolution_y) * _height;
}

const scm::math::mat4f& Image::get_transformation() const
{
