...
int main(int argc, char **argv) {
    ...
    // std::string out_dir  = "/mnt/terabytes_of_textures/montblanc/montblanc_full_w1202176_h304384.data";
    // TileStitcher stitcher(in_folder, out_file, 4696, 1189);

    std::string out_folder = "/mnt/terabytes_of_textures/montblanc";
    std::string file_name  = "mountblanc";
    TileStitcher stitcher(in_folder, out_folder, file_name, 100, 100);
#endif
